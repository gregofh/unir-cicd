...
class TestUtil(unittest.TestCase):
    ...
    def test_validate_permissions_user1_returns_true(self):
        self.assertTrue(util.validate_permissions("test_op", "user1"))
    
    def test_validate_permissions_other_user_returns_false(self):
        self.assertFalse(util.validate_permissions("test_op", "user2"))
        self.assertFalse(util.validate_permissions("test_op", "admin"))
        self.assertFalse(util.validate_permissions("test_op", ""))
        self.assertFalse(util.validate_permissions("test_op", None))